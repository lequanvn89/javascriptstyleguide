...
- [2.1](#2.1) <a name='2.1'></a> Для создания объекта используйте литерал объекта `{}`. Так проще и читабельней.
...
- [3.1](#3.1) <a name='3.1'></a> Для создания массива используйте литерал массива `[]`. Так проще и читабельней. 
...
- [3.2](#3.2) <a name='3.2'></a> Используйте оператор расширения `...` для копирование массивов.
...
- [6.2](#6.2) <a name='6.2'></a> Пишите чистые функции — не мутируйте аргументы, используйте значения аргументов по умолчанию, с `ES6` это стало возможно.
...
- [8.1](#8.1) <a name='8.1'></a> Сначала идут импорты стандартных библиотек, потом импорты модулей из проекта. Можно отделить эти импорты одной пустой строкой. После импортов отступаем две строки и пишем код.
